...
Compared to the bytecode representation in the official emulator, this enum-based approach is still more efficient, since it does not contain any pointers and thus no indirections.
