...
Rust has the ability to compile certain parts of the code only under certain conditions.
This not only allows parts of the code to be included only in certain builds of the application, but also allows the programmer to mark some dependencies as conditional.
